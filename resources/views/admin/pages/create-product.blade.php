...
@section('content')
    <form action="" onkeypress="return event.keyCode != '13'">
        <div class="row mt-5 shadow-1-strong mb-4 p-4">
            ...
            <input type="file" name="images[]" id="mainImage" class="filepond" required />
        </div>
        <div class="row my-4 shadow-1-strong p-4">
            <h3 class="mb-5">Product Info</h3>
            <h5>Product Title</h5>
            <div class="px-3 mb-5 w-75">
                <input name="name" type="text" id="form1" class="form-control" placeholder="Enter product title" required />
            </div>
        ...
        <div class="row mb-3 shadow-1-strong mb-4 p-4">
            ...
            <div id="variantContent">
                <button id="addVariant" type="button" class="btn btn-lg btn-success shadow-0 mb-5 w-100">
                    ADD VARIANT
                </button>
            </div>
        </div>
        <div class="row shadow-1-strong mb-4 p-4">
            ...
            <div id="productSetting">
                ...
                <div class="input-group mb-5 w-50">
                    ...
                    <input name="variants[1][price]" type="number" class="form-control" placeholder="Price" required />
                </div>
                <h5>Status</h5>
                <div class="form-check form-switch mb-5 mx-3">
                    <input name="variants[1][active]" class="form-check-input" type="checkbox" value="true"
                        id="flexSwitchCheckChecked" />
                    <label class="form-check-label" for="flexSwitchCheckChecked">Product Inactive/Active</label>
                </div>
                <h5>Stock</h5>
                <div class="mb-5 w-50">
                    <input name="variants[1][stock]" type="number" id="form1" class="form-control"
                        placeholder="Product stock" required />
                </div>
                <h5>SKU</h5>
                <div class="mb-5 w-50">
                    <input name="variants[1][sku]" type="text" id="form1" class="form-control" placeholder="Product SKU" />
                </div>
            </div>
        </div>
        <div class="row shadow-1-strong mb-4 p-4">
            ...
            <h5>Weight</h5>
            <div class="input-group mb-5 w-50">
                <input name="weight" type="number" class="form-control" placeholder="Product weight" required />
                <span class="input-group-text" id="basic-addon1">gr</span>
            </div>
            <h5>Dimensions</h5>
            <p class="small text-muted">Units in centimeter</p>
            <div class="input-group mb-5 w-50">
                <input name="dimensions[length]" type="number" aria-label="First name" class="form-control" />
                <span class="input-group-text">L</span>
                <input name="dimensions[width]" type="number" aria-label="Last name" class="form-control" />
                <span class="input-group-text">W</span>
                <input name="dimensions[height]" type="number" aria-label="Last name" class="form-control" />
