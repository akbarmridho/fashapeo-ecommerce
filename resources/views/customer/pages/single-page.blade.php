@extends('customer.layouts.main') @section('title') Single Page @endsection
@section('content')
<main>
    <!-- Carousel wrapper -->
    @include('customer.includes.single-page-header')
    <!-- Carousel wrapper -->
                    ...
                    <ul class="nav flex-column nav-pills menu-sidebar">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav flex-column ps-3">
                                <li class="nav-item">
                                    <a class="nav-link" href="#example-sub-A"
                                        >Subsection A</a
                                    >
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#example-sub-B"
                                        >Subsection B</a
                                    >
                                </li>
                            </ul>
