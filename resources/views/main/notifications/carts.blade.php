<section class="">
    <div class="toast d-flex align-items-center top-0 end-0 position-fixed m-3" id="cartSuccess" role="alert"
    ...
    <div class="toast d-flex align-items-center top-0 end-0 position-fixed m-3" id="cartDelete" role="alert"
        aria-live="assertive" aria-atomic="true">
        <div class="toast-body">
